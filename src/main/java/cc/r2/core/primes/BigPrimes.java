...
import static cc.r2.core.primes.QuadraticSieve.sqrtBigInt;

/**
 * Prime factorization for BigIntegers
 *
...
public final class BigPrimes {
    ...
    /**
     * Prime factors decomposition. The algorithm switches between trial divisions, Pollard's p-1, Pollard's rho
     * and quadratic sieve.
     *
