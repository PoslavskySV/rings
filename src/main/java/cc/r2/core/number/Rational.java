...
public final class Rational implements Comparable<Rational>, Serializable {
    ...
    /**
     * <p>
     * Create a {@link Rational} equivalent to the passed <tt>BigInteger</tt>, ie
     * "num / 1".
     * </p>
     *
    ...
    /**
     * <p>
     * Create a {@link Rational} equivalent to the passed <tt>int</tt>, ie
     * "num / 1".
     * </p>
     *
     * @param num the numerator.
     ...
     * <tt>int</tt>. The {@link Rational} is reduced to lowest terms.
     * </p>
     *
     * @param num the numerator.
    ...
    /**
     * <p>
     * Create a {@link Rational} equivalent to the passed long, ie "num / 1".
     * </p>
     *
     * @param num the numerator.
     */
     ...
     * <p>
     * Create a {@link Rational} given the numerator and denominator as simple
     * <tt>long</tt>. The {@link Rational} is reduced to lowest terms.
     * </p>
     *
     * @param num the numerator.
     * @param den the denominator.
    ...
    /**
     * <p>
     * Creates a <code>Rational</code> instance with the 2 parts of a fraction
     * Y/Z.
     * </p>
     * <p>
     * <p>
     ...
     * @return the fraction as a <code>BigDecimal</code>.
     * @throws IllegalArgumentException if <tt>roundingMode</tt> does not represent a valid rounding
     *                                  mode.
     * @see BigDecimal
     */
     ...
     * </p>
     *
     * @param exponent exponent to which this {@code Rational} is to be
     *                 raised.
    ...
    public Rational pow(final long exponent) {
        if (exponent < 0)
            return new Rational(BigIntegerArithmetics.pow(denominator, -exponent),
                    BigIntegerArithmetics.pow(numerator, -exponent));
        return new Rational(BigIntegerArithmetics.pow(numerator, exponent),
                BigIntegerArithmetics.pow(denominator, exponent));
    }
    ...
    public Rational pow(final BigInteger exponent) {
        if (exponent.compareTo(BigInteger.ZERO) < 0) {
            ...
            return new Rational(BigIntegerArithmetics.pow(denominator, eNeg),
                    BigIntegerArithmetics.pow(numerator, eNeg));
        }
        return new Rational(BigIntegerArithmetics.pow(numerator, exponent),
                BigIntegerArithmetics.pow(denominator, exponent));
    }
     ...
     * {@code Rational}, returning the result in reduced form.
     * </p>
     *
