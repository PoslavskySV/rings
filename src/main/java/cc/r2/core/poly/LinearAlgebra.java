...
import static cc.r2.core.poly.LinearAlgebra.SystemInfo.*;
...
public final class LinearAlgebra {
    ...
    /**
     * Solves linear system {@code lhs.x = rhs} and reduces the lhs to row echelon form. The result is stored in {@code result}
