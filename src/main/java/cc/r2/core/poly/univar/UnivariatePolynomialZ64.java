...
public final class UnivariatePolynomialZ64 extends AUnivariatePolynomial64<UnivariatePolynomialZ64> {
    ...
    public static UnivariatePolynomialZ64 parse(String string) {
        return UnivariatePolynomial.asLongPolyZ(Parser.parse(Domains.Z, Domains.Z, string));
    }
     ...
     * @return this modulo {@code modulus}
     */
    public UnivariatePolynomialZp64 modulus(IntegersZp64 domain, boolean copy) {
        long[] data = copy ? this.data.clone() : this.data;
        for (int i = degree; i >= 0; --i)
            data[i] = domain.modulus(data[i]);
        return UnivariatePolynomialZp64.createUnsafe(domain, data);
    }
     ...
     * @return a copy of this modulo {@code modulus}
     */
    public UnivariatePolynomialZp64 modulus(IntegersZp64 domain) {
    ...
    @Override
    public boolean sameDomainWith(UnivariatePolynomialZ64 oth) {return true;}
