...
public final class PolynomialArithmetics {
     ...
     */
    public static <T extends IMutablePolynomial<T>> T polyMod(T dividend, T polyModulus, boolean copy) {
     ...
     */
    public static <T extends IMutablePolynomial<T>> T polyMod(T dividend, T polyModulus,
     ...
     * @see DivisionWithRemainder#fastDivisionPreConditioning(IMutablePolynomial)
     */
    public static <T extends IMutablePolynomial<T>> T polyMultiplyMod(T m1, T m2,
     ...
     */
    public static <T extends IMutablePolynomial<T>> T polyPowMod(final T base, long exponent,
                                                                   T polyModulus,
                                                                   boolean copy) {
     ...
     * @see DivisionWithRemainder#fastDivisionPreConditioning(IMutablePolynomial)
     */
    public static <T extends IMutablePolynomial<T>> T polyPowMod(final T base, BigInteger exponent,
                                                                   T polyModulus, DivisionWithRemainder.InverseModMonomial<T> invMod,
                                                                   boolean copy) {
     ...
     */
    public static <T extends IMutablePolynomial<T>> T createMonomialMod(long exponent,
                                                                          T polyModulus,
     ...
     * @return {@code x^exponent mod polyModulus}
     */
    public static <T extends IMutablePolynomial<T>> T createMonomialMod(BigInteger exponent,
                                                                          T polyModulus,
                                                                          DivisionWithRemainder.InverseModMonomial<T> invMod) {
        if (exponent.signum() < 0)
            throw new IllegalArgumentException("Negative exponent: " + exponent);
    ...
    static <T extends IMutablePolynomial<T>> T smallMonomial(long exponent, T polyModulus, DivisionWithRemainder.InverseModMonomial<T> invMod) {
    ...
    /** repeated squaring */
    static <T extends IMutablePolynomial<T>> T largeMonomial(long exponent, T polyModulus, DivisionWithRemainder.InverseModMonomial<T> invMod) {
    ...
    /** repeated squaring */
    static <T extends IMutablePolynomial<T>> T largeMonomial(BigInteger exponent, T polyModulus, DivisionWithRemainder.InverseModMonomial<T> invMod) {
        T base = PolynomialArithmetics.polyMod(
                polyModulus.createMonomial(LongArithmetics.safeToInt(MONOMIAL_MOD_EXPONENT_THRESHOLD)),
                polyModulus, invMod, false);
