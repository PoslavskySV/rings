...
import cc.r2.core.poly.{IPolynomial, PolynomialMethods, WithVariables}
...
object implicits {
  ...
  final case class NumberOperators[Poly <: IPolynomial[Poly]](self: Long)(implicit ring: PolynomialRing[Poly]) {
    private implicit def operatorSupport(poly: Poly) = new IPolynomialOperators[Poly](poly)
  ...
  implicit def operatorSupportU64
  (number: Long)
  (implicit ring: PolynomialRing[UnivariatePolynomialZp64]) =
    NumberOperators[UnivariatePolynomialZp64](number)(ring)

  implicit def operatorSupportU[E <: AnyRef]
  (number: Long)
  (implicit ring: PolynomialRing[UnivariatePolynomial[E]]) =
    NumberOperators[UnivariatePolynomial[E]](number)(ring)

  implicit def operatorSupportM64
  (number: Long)
  (implicit ring: PolynomialRing[MultivariatePolynomialZp64]) =
    NumberOperators[MultivariatePolynomialZp64](number)(ring)

  implicit def operatorSupportM[E <: AnyRef]
  (number: Long)
  (implicit ring: PolynomialRing[MultivariatePolynomial[E]]) =
    NumberOperators[MultivariatePolynomial[E]](number)(ring)

  implicit def operatorSupportU64i
  (number: Int)
  (implicit ring: PolynomialRing[UnivariatePolynomialZp64]) =
    operatorSupportU64(number.asInstanceOf[Long])

  implicit def operatorSupportUi[E <: AnyRef]
  (number: Int)
  (implicit ring: PolynomialRing[UnivariatePolynomial[E]]) =
    operatorSupportU(number.asInstanceOf[Long])

  implicit def operatorSupportM64i
  (number: Int)
  (implicit ring: PolynomialRing[MultivariatePolynomialZp64]) =
    operatorSupportM64(number.asInstanceOf[Long])

  implicit def operatorSupportMi[E <: AnyRef]
  (number: Int)
  (implicit ring: PolynomialRing[MultivariatePolynomial[E]]) =
    operatorSupportM[E](number.asInstanceOf[Long])

  implicit def asBigInteger(l: Long) = BigInteger.valueOf(l)

  implicit def asBigInteger(l: Int) = BigInteger.valueOf(l.asInstanceOf[Long])
  ...
  def println(arg: Any)(implicit ring: PolynomialRing[_] = null): Unit = {
