...
public class DistinctDegreeFactorizationTest {
    ...
    public void sadasdsa() throws Exception {
        ...
        MutablePolynomialMod poly = MutablePolynomialZ.create(1, 2, 3, 1, 3, 1234, 1, 23, 2, 321, 435, 54, 543).modulus(modulus);
    ...
    public void test1() throws Exception {
        MutablePolynomialMod poly = MutablePolynomialMod.create(3, 0, -1, -1, -1, 0, 1, -1, 1, 1);
        FactorDecomposition<MutablePolynomialMod> f = DistinctDegreeFactorizationPlain(poly);
    ...
    public void test2() throws Exception {
        long modulus = 11;
        MutablePolynomialMod poly = MutablePolynomialMod
                .create(modulus, 32, 1, 4)
                .multiply(MutablePolynomialMod.create(modulus, 3, 3, 1));
    ...
    public void test3() throws Exception {
        ...
        MutablePolynomialMod poly = MutablePolynomialMod
                .create(modulus, 1, 1)
                .multiply(MutablePolynomialMod.create(modulus, 4, 9, 1));
        System.out.println(poly);
        FactorDecomposition<MutablePolynomialMod> plain = DistinctDegreeFactorizationPlain(poly);
        FactorDecomposition<MutablePolynomialMod> shoup = DistinctDegreeFactorizationShoup(poly);
