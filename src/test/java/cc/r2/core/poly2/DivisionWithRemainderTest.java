...
public class DivisionWithRemainderTest extends AbstractPolynomialTest {
    ...
    public void test4a() throws Exception {
        ...
        lMutablePolynomialZp[] qd = divideAndRemainder(dividend.clone(), divider, false);
    ...
    public void test5_SmallPolynomialsRandom() throws Exception {
        ...
        for (int i = 0; i < its(1000, 10_000); i++) {
            ...
            try {
                ...
                try {
                    lMutablePolynomialZ[] qr = pseudoDivideAndRemainderAdaptive(dividend, divider, true);
                    assertPseudoQuotientRemainder(dividend, divider, qr);
    ...
    public void test6_ModularSmallPolynomialsRemainderRandom() throws Exception {
        ...
        for (int i = 0; i < its(1000, 10_000); i++) {
            ...
            for (long prime : getModulusArray(9, 1, 40)) {
                ...
                lMutablePolynomialZp expected = divideAndRemainder(a, b, true)[1];
    ...
    public void test7_LinearDividerRandom() throws Exception {
        ...
        for (int i = 0; i < nIterations; i++) {
            ...
            lMutablePolynomialZ[] actual = divideAndRemainderLinearDivider(dividend, divider, true);
            fast.addValue(System.nanoTime() - start);
            start = System.nanoTime();
            lMutablePolynomialZ[] expected = divideAndRemainderGeneral0(dividend, divider, 1, true);
            ...
            for (long modulus : getSmallModulusArray(10)) {
                ...
                start = System.nanoTime();
                lMutablePolynomialZp[] actualMod = divideAndRemainderLinearDividerModulus(dividendMod, dividerMod, true);
                fast.addValue(System.nanoTime() - start);
                start = System.nanoTime();
                lMutablePolynomialZp[] expectedMod = divideAndRemainderClassic0(dividendMod, dividerMod, true);
                gen.addValue(System.nanoTime() - start);
                assertArrayEquals(expectedMod, actualMod);

                lMutablePolynomialZp[] actualNoCopyMod = divideAndRemainderLinearDividerModulus(dividendMod.clone(), dividerMod, false);
                lMutablePolynomialZp[] expectedNoCopyMod = divideAndRemainderClassic0(dividendMod.clone(), dividerMod, false);
    ...
    public void test12_FastDivisionRandom() throws Exception {
        ...
        for (int i = 0; i < its(100, 500); i++) {
            ...
            lMutablePolynomialZp[] fast = divideAndRemainderFast(a, b, invMod, true);
            lMutablePolynomialZp[] plain = divideAndRemainderClassic(a, b, true);
    ...
    public void test19_FastDivisionPerformance() throws Exception {
        ...
        for (int i = 0; i < nIterations; i++) {
            ...
            long start = System.nanoTime();
            lMutablePolynomialZp[] qdPlain = divideAndRemainderClassic(dividend, divider, true);
            long plain = System.nanoTime() - start;
            classic.addValue(plain);

            start = System.nanoTime();
            lMutablePolynomialZp[] qdNewton = divideAndRemainderFast(dividend, divider, invRev, true);
    ...
    public void test20_FastDivisionPerformance() throws Exception {
        ...
        for (int i = 0; i < nIterations; i++) {
            ...
            start = System.nanoTime();
            lMutablePolynomialZp[] qdNewton = divideAndRemainderFast(dividend, divider, true);
            long newton = System.nanoTime() - start;
            fast.addValue(newton);
    ...
    public void test21() throws Exception {
        ...
        lMutablePolynomialZp[] fast = divideAndRemainderFast(a, b, true);
        lMutablePolynomialZp[] plain = divideAndRemainderClassic(a, b, true);
        assertArrayEquals(fast, plain);
    }
    ...
    public void test22() throws Exception {
        ...
        bMutablePolynomialZp[] bqd = divideAndRemainderFast(bDividend, bDivider, true);
        lMutablePolynomialZp[] lqd = divideAndRemainderFast(lDividend, lDivider, true);
    ...
    public void test19_BigInteger_FastDivisionPerformance() throws Exception {
        ...
        DescriptiveStatistics classic = new DescriptiveStatistics(), fast = new DescriptiveStatistics();
        DivisionWithRemainder.InverseModMonomial<bMutablePolynomialZp> invRev = fastDivisionPreConditioning(divider);
        ...
        for (int i = 0; i < nIterations; i++) {
            ...
            long start = System.nanoTime();
            bMutablePolynomialZp[] qdPlain = divideAndRemainderClassic(dividend, divider, true);
            long plain = System.nanoTime() - start;
            classic.addValue(plain);

            start = System.nanoTime();
            bMutablePolynomialZp[] qdNewton = divideAndRemainderFast(dividend, divider, invRev, true);
            long newton = System.nanoTime() - start;
            fast.addValue(newton);
    ...
    public void test20_BigInteger_FastDivisionPerformance() throws Exception {
        ...
        for (int i = 0; i < nIterations; i++) {
            ...
            start = System.nanoTime();
            bMutablePolynomialZp[] qdNewton = divideAndRemainderFast(dividend, divider, true);
            long newton = System.nanoTime() - start;
            fast.addValue(newton);
    ...
    public void test23() throws Exception {
        ...
        bMutablePolynomialZp[] classic = divideAndRemainderClassic(dividend, divider, true);
        bMutablePolynomialZp[] fast = divideAndRemainderFast(dividend, divider, true);
