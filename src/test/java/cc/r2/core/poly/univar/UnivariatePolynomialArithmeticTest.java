...
public class UnivariatePolynomialArithmeticTest extends APolynomialTest {
    ...
    public void test3() throws Exception {
        Assert.assertEquals(lUnivariatePolynomialZ.create(1, 2, 1), UnivariatePolynomialArithmetic.polyPow(lUnivariatePolynomialZ.create(1, 1), 2, true));
        Assert.assertEquals(lUnivariatePolynomialZ.create(1, 2, 1), UnivariatePolynomialArithmetic.polyPow(lUnivariatePolynomialZ.create(1, 1), 2, false));
    }
    ...
    public void test5() throws Exception {
        ...
        Assert.assertEquals(lUnivariatePolynomialZ.create(0, -1, 0, 0, 1, 1, 1, -1).modulus(modulus), UnivariatePolynomialArithmetic.polyPowMod(a, modulus, polyModulus, true));
        Assert.assertEquals(lUnivariatePolynomialZ.create(0, -1, 0, 0, 1, 1, 1, -1).modulus(modulus), UnivariatePolynomialArithmetic.polyPowMod(a, modulus, polyModulus, false));
    }
    ...
    public void test6() throws Exception {
        ...
        for (int i = 0; i < its(100, 1000); i++) {
            lUnivariatePolynomialZ poly = RandomUnivariatePolynomials.randomPoly(rndd.nextInt(1, 5), 100, rnd);
            lUnivariatePolynomialZ polyModulus = RandomUnivariatePolynomials.randomPoly(rndd.nextInt(poly.degree == 1 ? 0 : 1, poly.degree), 100, rnd);
