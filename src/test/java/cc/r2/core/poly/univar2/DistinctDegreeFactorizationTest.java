...
import cc.r2.core.poly.univar2.FactorizationTestUtil.PolynomialSource;
import cc.r2.core.poly.univar2.FactorizationTestUtil.RandomSource;
import cc.r2.core.poly.univar2.FactorizationTestUtil.ShoupSource;
...
import static cc.r2.core.poly.univar2.FactorizationTestUtil.assertDistinctDegreeFactorization;
...
public class DistinctDegreeFactorizationTest extends AbstractPolynomialTest {
    ...
    public void test2() throws Exception {
        long modulus = 11;
        lMutablePolynomialZp poly = lMutablePolynomialZ
                .create(32, 1, 4)
                .modulus(modulus)
                .multiply(lMutablePolynomialZ
                        .create(3, 3, 1)
                        .modulus(modulus));
        FactorDecomposition<lMutablePolynomialZp> plain = DistinctDegreeFactorization.DistinctDegreeFactorizationPlain(poly);
        FactorDecomposition<lMutablePolynomialZp> shoup = DistinctDegreeFactorization.DistinctDegreeFactorizationShoup(poly);
...
//                .setPrintProgress(true)
    ...
    enum DDFAlgorithm {
        Plain {
            FactorizationTestUtil.WithTiming<FactorDecomposition<lMutablePolynomialZp>> factor(lMutablePolynomialZp poly) {
                long start = System.nanoTime();
                FactorDecomposition<lMutablePolynomialZp> r = DistinctDegreeFactorization.DistinctDegreeFactorizationPlain(poly);
        ...
        XPowers {
            FactorizationTestUtil.WithTiming<FactorDecomposition<lMutablePolynomialZp>> factor(lMutablePolynomialZp poly) {
                long start = System.nanoTime();
                FactorDecomposition<lMutablePolynomialZp> r = DistinctDegreeFactorization.DistinctDegreeFactorizationPrecomputedExponents(poly);
                long timing = System.nanoTime() - start;
                return new FactorizationTestUtil.WithTiming<>(r, timing);
            }
        },
        Shoup {
            FactorizationTestUtil.WithTiming<FactorDecomposition<lMutablePolynomialZp>> factor(lMutablePolynomialZp poly) {
                long start = System.nanoTime();
                FactorDecomposition<lMutablePolynomialZp> r = DistinctDegreeFactorization.DistinctDegreeFactorizationShoup(poly);
                long timing = System.nanoTime() - start;
                return new FactorizationTestUtil.WithTiming<>(r, timing);
            }
        };

        abstract FactorizationTestUtil.WithTiming<FactorDecomposition<lMutablePolynomialZp>> factor(lMutablePolynomialZp poly);
    }
        ...
        void run() throws IOException {
            ...
            for (int i = 0; i < nIterations; i++) {
                ...
                for (long modulus : primes) {
                    lMutablePolynomialZp poly = source.take(modulus);
                    degrees.addValue(poly.degree);
                    try {
                        Map<DDFAlgorithm, FactorizationTestUtil.WithTiming<FactorDecomposition<lMutablePolynomialZp>>> results = algorithms.stream().collect(Collectors.toMap(al -> al, al -> al.factor(poly)));
                        DDFAlgorithm baseAlgorithm = algorithms.stream().findFirst().get();
                        FactorDecomposition<lMutablePolynomialZp> baseDecomposition = results.get(baseAlgorithm).val;
                        factors.addValue(baseDecomposition.factors.size());
                        results.forEach((alg, res) -> {
                            performance.get(alg).addValue(res.nanoSeconds);

                            FactorDecomposition<lMutablePolynomialZp> c = res.val;
                            try {
    ...
    public void test35a() throws Exception {
        lMutablePolynomialZp poly = lMutablePolynomialZ
                ...
                .modulus(31);
        FactorDecomposition<lMutablePolynomialZp> factorization = DistinctDegreeFactorization.DistinctDegreeFactorizationPlain(poly);
    ...
    public void test38() throws Exception {
        lMutablePolynomialZp poly = lMutablePolynomialZ
                ...
                .modulus(181);
        FactorDecomposition<lMutablePolynomialZp> fct = DistinctDegreeFactorization.DistinctDegreeFactorizationComplete(poly);
        assertFactorization(poly, fct);
    }

    @Test
    public void test5() throws Exception {
        FactorDecomposition<lMutablePolynomialZp> ddf = DistinctDegreeFactorization.DistinctDegreeFactorization(bigPoly);
    ...
    public void test5a() throws Exception {
        for (int i = 0; i < its(10, 50); i++) {
            lMutablePolynomialZp bigPoly = this.bigPoly.setModulus(getModulusRandom(20));
            long start = System.nanoTime();
            FactorDecomposition<lMutablePolynomialZp> ddf = DistinctDegreeFactorization.DistinctDegreeFactorization(bigPoly);
            assertDistinctDegreeFactorization(bigPoly, ddf);
    ...
    public void test5b() throws Exception {
        for (int i = 0; i < its(100, 50); i++) {
            lMutablePolynomialZp bigPoly = this.bigPoly.setModulus(getModulusRandom(20));//.truncate(15);
            long start = System.nanoTime();
            FactorDecomposition<lMutablePolynomialZp> ddf = DistinctDegreeFactorization.DistinctDegreeFactorization(bigPoly);
            assertDistinctDegreeFactorization(bigPoly, ddf);
    ...
    public void test6() throws Exception {
        assertTrue(DistinctDegreeFactorization.DistinctDegreeFactorization(lMutablePolynomialZ.create(3, 7).modulus(17)).get(0).isMonic());
    }

    @Test
    public void test7() throws Exception {
        gMutablePolynomial<BigInteger> poly = gMutablePolynomial.create(Long.MAX_VALUE, Long.MAX_VALUE - 1, Long.MAX_VALUE - 2, Long.MAX_VALUE - 3);
        ...
        gMutablePolynomial<BigInteger> polyMod = poly.setDomain(new ModularDomain(modulus));
        FactorDecomposition<gMutablePolynomial<BigInteger>> f = DistinctDegreeFactorization(polyMod);
