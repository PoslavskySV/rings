 ...
 */
public class MultivariateQuotientRing<Term extends AMonomial<Term>, Poly extends AMultivariatePolynomial<Term, Poly>>
        extends AQuotientRing<Poly> implements IPolynomialRing<Poly> {
    /** the ideal */
    public final Ideal<Term, Poly> ideal;
    private final Poly factory;

    public MultivariateQuotientRing(IPolynomialRing<Poly> baseRing, Ideal<Term, Poly> ideal) {
        // fixme polys over Z ????
        super(baseRing);
        this.ideal = ideal;
