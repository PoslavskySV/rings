...
public final class Rings {
    ...
    AlgebraicExtension(Poly minimalPoly) {
     ...
     *
     * @deprecated Use either {@link #GF(IUnivariatePolynomial)} or {@link #AlgebraicExtension(IUnivariatePolynomial)}
     */
    @Deprecated
    public static <uPoly extends IUnivariatePolynomial<uPoly>>
    SimpleFieldExtension<uPoly>
    UnivariateQuotientRing(uPoly modulus) {
        return mkSimpleExtension(modulus);
    }
    ...
    public static <uPoly extends IUnivariatePolynomial<uPoly>>
    SimpleFieldExtension<uPoly>
    mkSimpleExtension(uPoly minimalPolynomial) {
        return minimalPolynomial.isOverFiniteField() ? GF(minimalPolynomial) : AlgebraicExtension(minimalPolynomial);
    }
