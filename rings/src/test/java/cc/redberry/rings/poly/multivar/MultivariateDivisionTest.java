...
public class MultivariateDivisionTest extends AMultivariateTest  {
    ...
    public void test1() throws Exception {
        ...
        MultivariatePolynomial<BigInteger> dividend = MultivariatePolynomial.parse("a*b^2 + 1", ordering, vars);
        MultivariatePolynomial<BigInteger> f1 = MultivariatePolynomial.parse("a*b + 1", ordering, vars);
        MultivariatePolynomial<BigInteger> f2 = MultivariatePolynomial.parse("b + 1", ordering, vars);


        MultivariatePolynomial<BigInteger>[] qd;
        qd = MultivariateDivision.divideAndRemainder(dividend, f1, f2);
        assertQuotientReminder(qd, dividend, f1, f2);
        assertArrayEquals(new MultivariatePolynomial[]{
                MultivariatePolynomial.parse("b", ordering, vars),
                MultivariatePolynomial.parse("-1", ordering, vars),
                MultivariatePolynomial.parse("2", ordering, vars)
        }, qd);

        qd = MultivariateDivision.divideAndRemainder(dividend, f2, f1);
        assertQuotientReminder(qd, dividend, f2, f1);
        assertArrayEquals(new MultivariatePolynomial[]{
                MultivariatePolynomial.parse("a*b - a", ordering, vars),
                MultivariatePolynomial.parse("0", ordering, vars),
                MultivariatePolynomial.parse("a+1", ordering, vars)
        }, qd);
    }
    ...
    public void test2() throws Exception {
        String[] vars = {"a", "b"};
        Comparator<DegreeVector> ordering = MonomialOrder.LEX;
        MultivariatePolynomial<BigInteger> dividend = MultivariatePolynomial.parse("a^2*b+a*b^2+b^2", ordering, vars);
        MultivariatePolynomial<BigInteger> f1 = MultivariatePolynomial.parse("a*b - 1", ordering, vars);
        MultivariatePolynomial<BigInteger> f2 = MultivariatePolynomial.parse("b^2 - 1", ordering, vars);
        ...
        assertQuotientReminder(qd, dividend, f1, f2);
        assertArrayEquals(new MultivariatePolynomial[]{
                MultivariatePolynomial.parse("a+b", ordering, vars),
                MultivariatePolynomial.parse("1", ordering, vars),
                MultivariatePolynomial.parse("a+b+1", ordering, vars)
        }, qd);
    ...
    public void test3() throws Exception {
        MultivariatePolynomial<BigInteger> a = RandomMultivariatePolynomials.randomPolynomial(5, 10, 10, getRandom());
        MultivariatePolynomial<BigInteger> b = RandomMultivariatePolynomials.randomPolynomial(5, 10, 10, getRandom());
        for (Comparator<DegreeVector> order : Arrays.asList(MonomialOrder.LEX, MonomialOrder.GRLEX, MonomialOrder.GREVLEX)) {
            ...
            assertTrue(MultivariateDivision.divideAndRemainder(c, a.setOrdering(order))[1].isZero());
            assertTrue(MultivariateDivision.divideAndRemainder(c, b.setOrdering(order))[1].isZero());
        }
    }
    ...
    public void test6() throws Exception {
        String[] vars = {"a", "b"};
        Ring<BigInteger> ring = new IntegersZp(2);
        Comparator<DegreeVector> ordering = MonomialOrder.LEX;
        MultivariatePolynomial<BigInteger> dividend = MultivariatePolynomial.parse("a^2*b+a*b^2+b^2", ring, ordering, vars);
        MultivariatePolynomial<BigInteger> f1 = MultivariatePolynomial.parse("a*b - 1", ring, ordering, vars);
        MultivariatePolynomial<BigInteger> f2 = MultivariatePolynomial.parse("b^2 - 1", ring, ordering, vars);
    ...
    static void testRandomReduce(int nIterations, int nVariables, int nDividers,
        ...
        testRandomReduce(nIterations, nVariables, nDividers, minSize, maxDegree, ordering, Rings.Z, getRandom());
    }
    ...
    static void testRandomReduce(int nIterations, int nVariables, int nDividers,
                                 int minSize, int maxDegree,
                                 Comparator<DegreeVector> ordering,
                                 Ring<BigInteger> ring, RandomGenerator rnd) {
        ...
        for (int n = 0; n < nIterations; n++) {
            ...
            MultivariatePolynomial<BigInteger> dividend = MultivariatePolynomial.zero(nVariables, ring, ordering);
            for (int j = 0; j < dividers.length; j++) {
                dividers[j] = RandomMultivariatePolynomials.randomPolynomial(nVariables, rndd.nextInt(1, maxDegree), rndd.nextInt(minSize, maxDegree), ring, ordering, rnd)
                        .mapCoefficients(ring, b -> b.remainder(BigInteger.valueOf(100)));
                if (dividers[j].isZero()) {
                    --j;
                    continue;
                }
                quotients[j] =
                        RandomMultivariatePolynomials.randomPolynomial(nVariables, rndd.nextInt(1, maxDegree), rndd.nextInt(minSize, maxDegree), ring, ordering, rnd)
                                .mapCoefficients(ring, b -> b.remainder(BigInteger.valueOf(100)));
            ...
            MultivariatePolynomial<BigInteger>[] qd = MultivariateDivision.divideAndRemainder(dividend, dividers);
            assertNotNull(qd);
    ...
    public static <E> void assertQuotientReminder(MultivariatePolynomial<E> dividend, MultivariatePolynomial<E>... dividers) {
        assertQuotientReminder(MultivariateDivision.divideAndRemainder(dividend, dividers), dividend, dividers);
    }
